...
export type AutoFinalizeResult = {
    'ok' : { 'requestId' : bigint, 'txHash' : string }
  } |
  {
    'alreadyExists' : {
      'status' : string,
...
export interface _SERVICE {
   ...
   * / #admin.
   */
  'adminGrantAdmin' : ActorMethod<[Principal], string>,
  /**
   ...
   * / `tx.from == ethAddress`.
   */
  'autoFinalizeUNIDeposit' : ActorMethod<
   ...
   */
  'getEthBalanceOnchain' : ActorMethod<[string], bigint>,
  /**
   ...
   */
  'getUniBalanceOnchain' : ActorMethod<[string], bigint>,
  ...
  'getWalletBalances' : ActorMethod<
    [string],
    { 'uniWei' : bigint, 'ethWei' : bigint }
  >,
  /**
