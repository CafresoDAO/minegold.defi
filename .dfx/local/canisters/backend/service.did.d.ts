...
export interface _SERVICE {
  ...
  >,
  /**
   * / Checks the user's ckUNI balance on the ledger. If it meets or exceeds expectedAmount,
   * / it records a #Mint transaction and then releases sGLDT from the treasury proportionally,
   * / recording a #Refine transaction. Returns "success", "pending", or "failed: <msg>".
   */
  'checkAndProcessCkUNIBalance' : ActorMethod<
